...
function deviceHtml(d){
  ...
  return '<div class="device" data-id="'+esc(d.registrationId)+'">'+
    '<div class="deviceHead"><div><div class="code">'+esc(d.deviceCode||'NO-CODE')+'</div><div class="meta">'+esc(deviceMeta)+'</div></div><span class="status">'+esc(statusLabel(d.status))+'</span></div>'+
